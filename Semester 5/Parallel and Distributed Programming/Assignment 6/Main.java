...
public class Main {
    public static void main(String[] args) {
        ...
        CycleManager findHamiltonianCycle = new CycleManager(graph);
        ...
        findHamiltonianCycle = new CycleManager(graphWithHamiltonianCycle);
        findHamiltonianCycle.beginSearch();
        ...
        findHamiltonianCycle = new CycleManager(graphWithoutHamiltonianCycle);
        findHamiltonianCycle.beginSearch();
