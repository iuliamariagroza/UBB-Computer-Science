...
public class Graph {
    ...
    public List<Integer> getUncoloredNeighbours(int v) {
    ...
    private boolean checkNode(int v) {
        for (Integer neigh : getUncoloredNeighbours(v)) {
            if (v > neigh)
                return false;
        }
        return true;
    ...
    public Integer getSmallestColorAvailable(int node) {
    ...
    public void setColor(int v) {
        nodesInfo.get(v).color = getSmallestColorAvailable(v);
    }
